...
public class PayOffCommandFactory extends CommandFactory{

    Profile profile;

    PayOffCommandFactory(Profile profile){
        this.profile = profile;
    }

    public void execute(String... args) throws ServiceException {
        try {
            ((Customer) profile).payOff(Integer.parseInt(args[0], 16), Integer.parseInt(args[1]));
