...
public class ReplenishCommandFactory extends ProfiledCommandFactory{
    ...
    public void execute(String... args) throws ServiceException {
        try {
            ((CustomerService) profile).replenish(Integer.parseInt(args[0], 16), Integer.parseInt(args[1]));
